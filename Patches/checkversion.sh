...
if [ "$VERSIONCURRENT" = "Twister OS version 1.8.0" ]; then
    read -p "You appear to be running Twister OS version 1.8.0. Is this correct? Press [Enter] if yes, or [CTRL+C] if no. This version has a new feature, twistver, run twistver in terminal to check your version if you are unsure."
       	echo 'Downloading 1.8.1 Patch...'
	wget https://twisteros.com/Patches/TwisterOSv1-8-1Patch.zip
	echo 'Extracting .zip...'
	unzip *.zip
	rm *.zip
    clear
...
if [ "$VERSIONCURRENT" = "Twister OS version 1.8.1" ]; then
    read -p "You appear to be running Twister OS version 1.8.1. Is this correct? Press [Enter] if yes, or [CTRL+C] if no. This version has a new feature, twistver, run twistver in terminal to check your version if you are unsure."
       	echo 'Downloading 1.8.2 Patch...'
	wget https://twisteros.com/Patches/TwisterOSv1-8-2Patch.zip
	echo 'Extracting .zip...'
	unzip *.zip
	rm *.zip
    clear
